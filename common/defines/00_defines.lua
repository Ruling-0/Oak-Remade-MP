...
NDiplomacy = {
	...
	BASE_SEND_ATTACHE_CP_COST = 20.0,				-- Command Power sent attache usage cost
...
NMilitary = {
	...
	ANTI_AIR_TARGETTING_TO_CHANCE = 0.019,			-- Balancing value to determine the chance of ground AA hitting an attacking airplane, affecting both the effective average damage done by AA to airplanes, and the reduction of damage done by airplanes due to AA support
