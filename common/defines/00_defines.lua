...
NNavy = {
	...
	ADMIRAL_TASKFORCE_CAP = 20,										-- admirals will start getting penalties after this amount of taskforces
	...
	ANTI_AIR_TARGETTING_TO_CHANCE = 0.175,							-- Balancing value to convert averaged equipment stats (anti_air_targetting and naval_strike_agility) to probability chances of airplane being hit by navies AA.
